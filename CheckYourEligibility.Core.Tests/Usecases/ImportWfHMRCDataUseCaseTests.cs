...
public class ImportWfHMRCDataUseCaseTests : TestBase
{
    ...
    public async Task Execute_Should_Process_Xlsm_File_And_Call_ImportWfHMRCData()
    {
        ...
        var stream = Assembly.GetExecutingAssembly().GetManifestResourceStream("CheckYourEligibility.Core.Tests.Resources.HMRCManualEligibilityEvent.xlsm");
    ...
    public void Execute_InvalidData_Should_Throw_Validation_Exception()
    {
        ...
        var stream = Assembly.GetExecutingAssembly().GetManifestResourceStream("CheckYourEligibility.Core.Tests.Resources.HMRCManualEligibilityEvent_invalid.xlsm");
        fileMock.Setup(f => f.OpenReadStream())
            .Returns(stream);
