...
public class UserGatewayTests : TestBase
{
    ...
    public async Task Given_Existing_Portal_User_Should_Update_LastLogin(UserType userType)
    {
        ...
        var existingUser = new User
        {
            ...
            UserType = userType,
            OrganisationType = Core.Domain.Enums.OrganisationType.local_authority,
            OrganisationId = 123,
    ...
    [TestCase(Core.Domain.Enums.OrganisationType.local_authority)]
    [TestCase(Core.Domain.Enums.OrganisationType.multi_academy_trust)]
    [TestCase(Core.Domain.Enums.OrganisationType.establishment)]
    [Test]
    public async Task Given_Existing_Api_User_Should_Update_LastLogin(Core.Domain.Enums.OrganisationType organisationType)
    {
        // Arrange
        var existingUser = new User
        {
