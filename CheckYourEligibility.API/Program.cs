...
builder.Services.AddScoped<ICreateEligibilityCheckReportUseCase, CreateEligibilityCheckReportUseCase>();
builder.Services.AddScoped<IGetEligibilityReportUseCase, GetEligibilityCheckReportUseCase>();
