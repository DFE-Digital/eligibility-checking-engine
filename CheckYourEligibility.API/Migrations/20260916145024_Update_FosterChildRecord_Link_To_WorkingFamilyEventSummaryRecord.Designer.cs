...
namespace CheckYourEligibility.API.Migrations
{
    ...
    [Migration("20260916145024_Update_FosterChildRecord_Link_To_WorkingFamilyEventSummaryRecord")]
    partial class Update_FosterChildRecord_Link_To_WorkingFamilyEventSummaryRecord
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CheckYourEligibility.API.Domain.WorkingFamiliesEvent", b =>
                {
                    ...
                    b.Property<string>("HMRCEligibilityEventId")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasIndex(new[] { "HMRCEligibilityEventId" }, "idx_WorkingFamiliesEvents_HMRCEligibilityEventId");
            ...
            modelBuilder.Entity("CheckYourEligibility.API.Domain.WorkingFamiliesEventSummary", b =>
                {
                    ...
                    b.Property<string>("ChildFirstNameTruncated")
                        .IsRequired()
                    ...
                    b.Property<int?>("FirstCheckLocalAuthorityId")
                        .HasColumnType("int");
                    ...
                    b.Property<bool>("HasCodeBeenCheckedByOwningLA")
                        .HasColumnType("bit");

                    b.Property<DateTime?>("LastCheckDate")
                        .HasColumnType("datetime2");

                    b.Property<int?>("LastCheckLocalAuthorityId")
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("OwningLocalAuthorityId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("WorkingFamiliesEventSummaryID");

                    b.HasIndex("EligibilityCode");

                    b.HasIndex("OwningLocalAuthorityId");

                    b.ToTable("WorkingFamiliesEventSummaries");
                });
            ...
            modelBuilder.Entity("EligibilityCheckReportItem", b =>
                {
                    ...
                    b.HasOne("EligibilityCheckReport", "EligibilityCheckReport")
                        .WithMany()
                        .HasForeignKey("EligibilityCheckReportId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("EligibilityCheck");

                    b.Navigation("EligibilityCheckReport");
                });
            ...
            modelBuilder.Entity("FosterChild", b =>
                {
                    b.HasOne("FosterCarer", "FosterCarer")
                        .WithMany("FosterChildren")
                        .HasForeignKey("FosterCarerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
