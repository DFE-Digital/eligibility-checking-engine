        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OwningLocalAuthorityId = table.Column<int>(type: "int", nullable: true),
                    ...
                    ChildPostCode = table.Column<string>(type: "nvarchar(9)", nullable: false),
                    ChildFirstName = table.Column<string>(type: "nvarchar(100)", nullable: false),
                    ChildFirstNameTruncated = table.Column<string>(type: "nvarchar(26)", nullable: false),
                    ParentNationalInsuranceNumber = table.Column<string>(type: "nvarchar(9)", nullable: false),
                    PartnerNationalInsuranceNumber = table.Column<string>(type: "nvarchar(9)", nullable: true),
