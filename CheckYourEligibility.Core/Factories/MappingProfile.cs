...
using static CheckYourEligibility.Core.Boundary.Responses.ApplicationResponse;
using ApplicationEvidence = CheckYourEligibility.Core.Domain.ApplicationEvidence;
using Establishment = CheckYourEligibility.Core.Domain.Establishment;

namespace CheckYourEligibility.Core.Data.Mappings;
...
public class MappingProfile : Profile
{
    public MappingProfile()
    {
        ...
        CreateMap<WorkingFamiliesEvent, WorkingFamiliesEventEligibilityCodeResponseRecord>()
